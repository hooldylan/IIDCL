...
class Block(nn.Module):
    ...
    # act_layer=nn.GELU 应用高斯误差线性单位函数：
    ...
    # 分割图片，图片分割为patch_size个块，每一块输出768维
...
class TransReID(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, stride_size=16, 
        in_chans=3, num_classes=0, embed_dim=768, depth=12,num_heads=12, 
        ...
        if conv_stem:
            ...
            # 将图片分割为patch_size个块，每一块是embed_dim维
        ...
        # 将cls_token 和 pos_embed 变为可学习的参数
