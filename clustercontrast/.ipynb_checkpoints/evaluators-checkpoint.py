...
def evaluate_all(query_features, gallery_features, distmat, query=None, gallery=None,
                 ...
                 cmc_topk=(1, 5, 10), cmc_flag=False, draw_image=False):
    ...
    if draw_image:
        return mean_ap(distmat, query_ids, gallery_ids, query_cams, gallery_cams, draw_image=True)
    ...
    print('CMC Scores:')
    for k in cmc_topk:
        print('  top-{:<4}{:12.3%}'.format(k, cmc_scores['market1501'][k-1]))
